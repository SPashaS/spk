...
(() => {
        ...
        e.exports = (function () {
          ...
          var t = "undefined" != typeof window,
            ...
            U = function (e, t, i) {
              L(e, t.class_loading),
                C(e, m),
                i && (z(i, 1), P(t.callback_loading, e, i));
            },
            K = function (e, t, i) {
                  ...
                  function (n) {
                    !(function (e, t, i, s) {
                      ...
                      re(t, i, s),
                        L(t, i.class_error),
                        C(t, y),
                        P(i.callback_error, t, s),
                        i.restore_on_error && Y(t, N),
                        n || ee(i, s);
                    })(0, e, t, i),
                      ne(s);
                  }
                      ...
                      I(e) ||
                        ...
                        (function (e, t, i, s) {
                          i.cancel_on_exit &&
                            ...
                            z(s, -1),
                            E(e),
                            P(i.callback_cancel, e, t, s));
                        })(e, t, i, s),
                        P(i.callback_exit, e, t, s));
                    })(e.target, e, t, i);
              });
            },
            me = function (e) {
  ...
  (() => {
    ...
    const z = {
      ...
      updateSlides: function () {
        ...
        const s = e.params,
          ...
          u = b(r, `.${e.params.slideClass}, swiper-slide`),
    ...
    function V(e) {
      ...
      p && l.target && l.target.shadowRoot && g && (c = g[0]);
    ...
    function H(e) {
      ...
      const u = s.evCache.length > 1 ? s.evCache[0] : l,
        p = u.pageX,
        g = u.pageY;
      if (l.preventedByNestedSwiper) return (r.startX = p), void (r.startY = g);
      if (!i.allowTouchMove)
        return (
    ...
    const Q = {
        ...
        breakpoints: {
          setBreakpoint: function () {
            ...
            u && i && e.changeDirection(), f(e.params, a);
    ...
    class ee {
      ...
      getSlideIndex(e) {
        const { slidesEl: t, params: i } = this,
          s = x(b(t, `.${i.slideClass}, swiper-slide`)[0]);
        return x(e) - s;
      }
      ...
      se(),
        ...
        document.querySelector(".certificates__slider") &&
          new te(".certificates__slider", {
            ...
            navigation: {
              prevEl:
                ".certificates__navigation .navigation-slider__button_prev",
              nextEl:
                ".certificates__navigation .navigation-slider__button_next",
            },
            breakpoints: {
        ...
        document.querySelector(".testimonials__slider") &&
          new te(".testimonials__slider", {
            ...
            navigation: {
              prevEl:
                ".testimonials__navigation .navigation-slider__button_prev",
              nextEl:
                ".testimonials__navigation .navigation-slider__button_next",
            },
            breakpoints: {
              0: { slidesPerView: 1, spaceBetween: 10 },
    ...
    var Pe = function (e, t, i, s) {
        void 0 === i && (i = 0);
        var n = Ie(e).attr("data-lg-size") || s;
        if (n) {
          var r = n.split(",");
          if (r[1])
        ...
        return (
          ...
          (e.prototype.openGallery = function (e, t) {
            ...
            if ((void 0 === e && (e = this.settings.index), !this.lgOpened)) {
              ...
              this.zoomFromOrigin &&
                ...
                (r = Le(t, this.outer, a, l, this.currentImageSize))),
          ...
          (e.prototype.addHtml = function (e) {
            ...
            if (".lg-item" !== this.settings.appendSubHtmlTo)
              ...
              var n = Ie(this.getSlideItemId(e));
              i
                ? n.load(i)
          ...
          (e.prototype.getDummyImageContent = function (e, t, i) {
            var s;
            if ((this.settings.dynamic || (s = Ie(this.items).eq(t)), s)) {
              var n = void 0;
              if (
          ...
          (e.prototype.loadContent = function (e, t) {
            ...
            if (
              ...
              if (m) {
                ...
                x = Ge(r, T || "", g, this.settings.strings.playVideo, h);
                n.prepend(x);
              } else if (h) {
          ...
          (e.prototype.enableDrag = function () {
            ...
            this.settings.enableDrag &&
              ...
              Ie(window).on("mousemove.lg.global" + this.lgId, function (r) {
                s &&
                  e.lgOpened &&
                  ((n = !0),
              ...
              Ie(window).on("mouseup.lg.global" + this.lgId, function (r) {
                if (e.lgOpened) {
                  var o = Ie(r.target);
                  n
            ...
            return (
              ...
              setTimeout(function () {
                t.zoomFromOrigin &&
                  ...
                  t.$inner.empty(),
                  t.lgOpened && t.LGel.trigger(Te, { instance: t }),
